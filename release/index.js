...
var DatatableComponent = /** @class */ (function () {
    function DatatableComponent(scrollbarHelper, dimensionsHelper, cd, element, differs, columnChangesService) {
        ...
        this._canShowDataTable = new rxjs_1.BehaviorSubject(true);
        this.rowCount = 0;
    ...
    Object.defineProperty(DatatableComponent.prototype, "canShowDataTable", {
        /**
     ...
     */
    DatatableComponent.prototype.setCanShowDataTable = function (val) {
...
var OrderableDirective = /** @class */ (function () {
    ...
    OrderableDirective.prototype.isTarget = function (model, event) {
        ...
        if (this.document.msElementsFromPoint !== undefined) {
            x = event.clientX;
            y = event.clientY;
        }
